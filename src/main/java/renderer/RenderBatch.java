...
public class RenderBatch {
    ...
    public void render(){
        ...
        //Use shader
        shader.use();
        shader.uploadMatf4("uProjection", Window.getScene().camera().getProjectionMatrix());
        shader.uploadMatf4("uView", Window.getScene().camera().getViewMatrix());
